...
use super::GeminiAppState; // AppState from the parent gemini_integration module

// --- Example Tool 1: Get Current Weather ---
#[derive(Deserialize, Debug)]
struct WeatherApiResponse {
    main: Option<WeatherMain>,
    weather: Option<Vec<WeatherDescription>>,
    name: Option<String>,
    cod: Option<serde_json::Value>, // Can be string or int
...
pub fn register_all_tools(
    ...
    let builder = get_weather_register_tool(builder); // Macro-generated by #[tool_function]
